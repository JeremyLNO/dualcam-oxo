...
/// `CrazyBeeLicense` package, but the *purchase* is a StoreKit In-App Purchase —
/// App Review 3.1.1 doesn't allow unlocking iOS features with a web licence, so the
/// macOS licence-key screen is not used here.
