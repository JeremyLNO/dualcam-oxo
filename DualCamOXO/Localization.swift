...
enum L {
    ...
    static let table: [String: [AppLanguage: String]] = [
        ...
        "pro_active": [.en: "DualCam OxO Pro active", .fr: "DualCam OxO Pro actif", .es: "DualCam OxO Pro activo", .de: "DualCam OxO Pro aktiv", .pt: "DualCam OxO Pro ativo"],
        // Paywall (In-App Purchase — App Review 3.1.1: iOS unlocks are IAP only)
        "pay_trial_ended": [.en: "Your free trial has ended", .fr: "Votre essai gratuit est terminé", .es: "Tu prueba gratuita ha terminado", .de: "Deine kostenlose Testphase ist beendet", .pt: "O seu teste gratuito terminou"],
        "pay_get_pro": [.en: "Unlock everything", .fr: "Tout débloquer", .es: "Desbloquéalo todo", .de: "Alles freischalten", .pt: "Desbloquear tudo"],
        "pay_subtitle": [.en: "One purchase. Yours forever, on all your devices.", .fr: "Un seul achat. À vous pour toujours, sur tous vos appareils.", .es: "Una sola compra. Tuya para siempre, en todos tus dispositivos.", .de: "Ein Kauf. Für immer deins, auf all deinen Geräten.", .pt: "Uma só compra. Sua para sempre, em todos os dispositivos."],
        "pay_lifetime": [.en: "Lifetime unlock", .fr: "Déblocage à vie", .es: "Desbloqueo de por vida", .de: "Lebenslang freigeschaltet", .pt: "Desbloqueio vitalício"],
        "pay_lifetime_detail": [.en: "Pay once — no subscription.", .fr: "Payez une fois — sans abonnement.", .es: "Paga una vez — sin suscripción.", .de: "Einmal zahlen — kein Abo.", .pt: "Pague uma vez — sem subscrição."],
        "pay_buy": [.en: "Unlock DualCam OxO Pro", .fr: "Débloquer DualCam OxO Pro", .es: "Desbloquear DualCam OxO Pro", .de: "DualCam OxO Pro freischalten", .pt: "Desbloquear o DualCam OxO Pro"],
        "pay_store_unavailable": [.en: "The App Store is unreachable right now. Check your connection and try again.", .fr: "L'App Store est injoignable pour le moment. Vérifiez votre connexion et réessayez.", .es: "No se puede acceder al App Store ahora mismo. Comprueba tu conexión e inténtalo de nuevo.", .de: "Der App Store ist gerade nicht erreichbar. Prüfe deine Verbindung und versuche es erneut.", .pt: "A App Store está inacessível neste momento. Verifique a ligação e tente novamente."],
        "pay_error_unverified": [.en: "That purchase couldn't be verified.", .fr: "Cet achat n'a pas pu être vérifié.", .es: "No se pudo verificar la compra.", .de: "Der Kauf konnte nicht überprüft werden.", .pt: "Não foi possível verificar a compra."],
        "pay_pending": [.en: "Purchase pending approval.", .fr: "Achat en attente d'approbation.", .es: "Compra pendiente de aprobación.", .de: "Kauf wartet auf Freigabe.", .pt: "Compra a aguardar aprovação."],
        ...
        "pay_terms": [.en: "Payment is charged to your Apple Account at confirmation. This is a one-time purchase, not a subscription.", .fr: "Le paiement est débité de votre compte Apple à la confirmation. Il s'agit d'un achat unique, pas d'un abonnement.", .es: "El pago se cargará a tu cuenta de Apple al confirmar. Es una compra única, no una suscripción.", .de: "Die Zahlung wird bei Bestätigung deinem Apple-Account belastet. Einmalkauf, kein Abo.", .pt: "O pagamento é cobrado na sua conta Apple ao confirmar. É uma compra única, não uma subscrição."],
        "pay_processing": [.en: "Processing…", .fr: "Traitement…", .es: "Procesando…", .de: "Wird verarbeitet…", .pt: "A processar…"],
