...
See `AGENTS.md` → *À compléter avant publication*: set `AppInfo.appStoreID`. Push is done —
the OneSignal package is linked, the App ID is set and `aps-environment` is `production`.
